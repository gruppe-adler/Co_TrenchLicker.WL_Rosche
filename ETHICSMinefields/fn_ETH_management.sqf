...
ETH_killzoneVisibleOnMap = false;   // true = The faction kill zone is visible on map only by its faction player / false = invisible for everyone. Defalt: true
...
ETH_globalDevicesIntensity = "EXTREME";    // Proportional number of explosives through the area-markers. Options: "EXTREME", "HIGH", "MID", "LOW", "LOWEST". Default: "MID"
