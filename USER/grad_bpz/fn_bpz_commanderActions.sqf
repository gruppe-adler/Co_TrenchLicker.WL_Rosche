["gm_ge_army_bpz2a0", "init", {
    ...
    // [_vehicle] call grad_bpz_fnc_buildTrench;
    ...
    [
        "<t color='#FF0000'>Enter Recovery Mode</t>",
        {
            ...
            [_target, true] call grad_bpz_fnc_bpz_recoveryMode;
        },
        nil,
        7,
        true,
    ...
    [
         "<t color='#FF0000'>Exit Recovery Mode</t>",
        {
            ...
            [_target, false] call grad_bpz_fnc_bpz_recoveryMode;
        },
        nil,
        7,
        true,
    ...
    // [_vehicle] call grad_bpz_fnc_buildTrench_pfhLocal;
    ...
    */
    ...
    [
        "Extend Rope",
        {
            ...
            [_target, true] call grad_bpz_fnc_bpz_ropeUnwind;
        },
        nil,
        1.5,
        true,
    ...
    [
        "Retract Rope",
        {
            ...
            [_target, false] call grad_bpz_fnc_bpz_ropeUnwind;
        },
        nil,
        1.5,
        true,
